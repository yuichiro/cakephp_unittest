<?php $paginator->options( array( 'update' => 'result2', "url" => $this->passedArgs ) );?>

<!-- お知らせ一覧 -->
<div class="pageMoveBox" style="width:620px;">
<div class="pageMoveBox-inner">
	<ul class="pageMove">
		...
		<li>（全<?php echo number_format( $paginator->counter( array( "format" => "%count%" ) ) );?>件）</li>
